                                ...
                                $.each(categoryListDto.Categories.$values, function (index, category) {
                                    tableBody += `
                                        <tr name="${category.Id}">
                                            ...
                                            <td>
                                                <a class="btn btn-warning btn-sm"><span class="fas fa-edit"></span></a>
                ...
                if (isValid) {
                    ...
                    const newTableRow = `
                        <tr name="${categoryAddAjaxModel.CategoryDto.Category.Id}">
                            ...
                            <td>
                                <a class="btn btn-warning btn-sm"><span class="fas fa-edit"></span></a>
                                <a class="btn btn-danger btn-sm btn-delete" data-id="${categoryAddAjaxModel.CategoryDto.Category.Id}"><span class="fas fa-trash"></span></a>
                            </td>
                        </tr>`;
