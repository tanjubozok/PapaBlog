                                ...
                                $.each(userListDto.Users.$values,
                                    function (index, user) {
                                        const newTableRow = dataTable.row.add([
                                            ...
                                            <button class="btn btn-danger btn-sm btn-delete" data-id="${user.Id}"><span class="fas fa-trash"></span></button>`
                                        ]).node();
                ...
                success: function (data) {
                    ...
                    if (isValid) {
                        ...
                        const newTableRow = dataTable.row.add([
                            ...
                            `<img src="/img/${userAddAjaxModel.UserDto.Users.Picture}" alt="${userAddAjaxModel.UserDto.Users.UserName}" class="my-image-table" />`,
                            `<button class="btn btn-warning btn-sm btn-update" data-id="${userAddAjaxModel.UserDto.Users.Id}"><span class="fas fa-edit"></span></button>
                            <button class="btn btn-danger btn-sm btn-delete" data-id="${userAddAjaxModel.UserDto.Users.Id}"><span class="fas fa-trash"></span></button>`
                        ]).node();
                        const jqueryTableRow = $(newTableRow);
                        jqueryTableRow.attr('name', `${userAddAjaxModel.UserDto.Users.Id}`);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (userDto.ResultStatus === 0) {
                            Swal.fire(
                                'Silindi!',
                                `${userDto.Users.UserName} adlı kullanıcı başarıyla silinmiştir.`,
                                'success'
                            );
                ...
                success: function (data) {
                    ...
                    if (isValid) {
                        ...
                        dataTable.row(tableRow).data([
                            userUpdateAjaxModel.UserDto.Users.Id,
                            userUpdateAjaxModel.UserDto.Users.UserName,
                            userUpdateAjaxModel.UserDto.Users.Email,
                            userUpdateAjaxModel.UserDto.Users.PhoneNumber,
                            `<img src="/img/${userUpdateAjaxModel.UserDto.Users.Picture}" alt="${userUpdateAjaxModel.UserDto.Users.UserName}" class="my-image-table" />`,
                            `<button class="btn btn-warning btn-sm btn-update" data-id="${userUpdateAjaxModel.UserDto.Users.Id}"><span class="fas fa-edit"></span></button>
                            <button class="btn btn-danger btn-sm btn-delete" data-id="${userUpdateAjaxModel.UserDto.Users.Id}"><span class="fas fa-trash"></span></button>`
                        ]);
